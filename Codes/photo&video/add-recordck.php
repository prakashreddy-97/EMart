...
$add="C:/xampp/htdocs/EMart/Codes/photo&video/images/$file_name"; 
...
$query="INSERT INTO photoandvideo (p_name,price,img,description,unique_id) values('$p_name','$price','$file_name','$description','$unique_id')";
