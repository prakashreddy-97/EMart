...
$date = date("Y-m-d");
$historyQuery = "INSERT INTO adminHistory(p_name,`action`,img,category,dateModified) values('$p_name','Deleted','$file_name','speakers','$date')";
$stmt2 = $connection->prepare($historyQuery);
$stmt2->execute();

////Delete record from table ///
$query="DELETE FROM c_table WHERE unique_id=? and category ='speakers'";
